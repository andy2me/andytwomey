    ...
    <div class="overflow-hidden">
      ...
      >
        <div class="w-full py-10 lg:pb-32">
          ...
          <h1
            v-html="title"
            class="mt-6 text-gray-800 text-3xl leading-none tracking-wide font-bold xs:max-w-xs sm:max-w-md md:mt-12 md:text-5xl lg:max-w-3xl lg:text-6xl xl:max-w-6xl xl:text-7xl xxl:max-w-7xl xxl:text-8xl xxl:mt-12"
          ></h1>

          <p
            v-if="content"
            v-html="content"
            class="font-medium text-gray-700 text-base mt-10 inline-block rounded-lg md:text-lg xxl:text-4xl xxl:leading-tight xxl:font-bold"
          ></p>
        ...
        <img v-if="imgSrc" class="hero-image" :src="imgSrc" :alt="imgAlt" />
      </div>
      <a
        v-if="scrollDown"
