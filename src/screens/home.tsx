      ...
      <Root layout={{ '@initial': 'portrait', '@bp1': 'landscape' }}>
        <ContentContainer layout={{ '@initial': 'portrait', '@bp1': 'landscape' }}>
          ...
          <Body>
            ...
            <Paragraph css={{ marginBottom: '$3' }}>Actively creating <Link href="https://blog.andytwomey.com" title="Focus by Andy">Focus</Link> to help teams plan and execute their work better.
